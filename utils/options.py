...
def get_args():
    parser = argparse.ArgumentParser(description="AVSFA Args")
    ######################## general settings ########################
    ...
    parser.add_argument("--finetune", type=str, default="../../pt/best2.pth")
    ...
    ######################## loss settings ########################
    parser.add_argument("--loss_names", default='TAL+id', help="VTC+FGSM")
    ...
    parser.add_argument('--ot_gamma', type=float, default=1)
    parser.add_argument('--img_k_ratio', type=float, default=0.8)
    parser.add_argument("--tau", default=0.015, type=float)
    parser.add_argument("--margin", default=0.1, type=float)
    parser.add_argument('--i_feats_fg_gamma', type=float, default=1.0)
